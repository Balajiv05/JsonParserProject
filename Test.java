...
public class Test {
	...
	static{
		 PropertyConfigurator.configure("src/com/infy/commons/log4j.properties");
	...
	public static void main(String[] args) throws IOException {
		 ...
		 String result = "";
	        ...
	        try {
	        	...
	        	File file = new File("F:\\TimeSheet\\MicroservicesWorkSpace\\HSBCJsonProject2222222\\sample.txt");  
